<template>
    ...
    <AdminLayout>
      <div class="container mx-auto py-8">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-gray-300 mb-6">Edit Role Permissions</h1>
        <form @submit.prevent="submit" class="space-y-6">
          <!-- Role Field -->
          <div class="bg-white p-4 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <input
              ...
              v-model="form.role"
              readonly
              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600"
            />
          </div>
          ...
          <div class="bg-white p-4 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="mt-2 space-y-4">
              <label v-for="permission in permissions" :key="permission.id" class="flex items-center dark:text-gray-300">
                <input
                  type="checkbox"
                  :value="permission.id"
                  v-model="form.permissions"
                  class="form-checkbox h-5 w-5 text-blue-600 dark:text-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-500"
                />
            ...
            <div v-if="selectedPermissions.length > 0" class="mt-4">
              <p class="text-sm font-medium text-gray-800 dark:text-gray-300">Selected Permissions:</p>
              <ul class="list-disc list-inside mt-1 text-sm text-gray-700 dark:text-gray-300">
            ...
            <div v-if="uncheckedPermissions.length > 0" class="mt-4">
              <p class="text-sm font-medium text-gray-800 dark:text-gray-300">Unchecked Permissions:</p>
              <ul class="list-disc list-inside mt-1 text-red-600 dark:text-red-500 text-sm">
          ...
          <div class="flex justify-end">
            <button type="submit" class="btn-primary dark:bg-blue-700 dark:hover:bg-blue-600 dark:text-gray-300" :disabled="form.processing">Update Permissions</button>
          </div>
        </form>
      </div>
    </AdminLayout>
